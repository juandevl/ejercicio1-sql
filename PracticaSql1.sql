...
--INSERT INTO DISCOS VALUES ('Midnight Grooves', SMALLDATETIMEFROMPARTS(2020,04,15,00,00), 12, 'midnight_grooves.jpg', (SELECT Id FROM ESTILOS WHERE Descripcion = 'Soul'), (SELECT Id FROM TIPOSEDICION WHERE Descripcion = 'Vinilo'));
--INSERT INTO DISCOS VALUES ('Ecliptic Echoes', SMALLDATETIMEFROMPARTS(2018,09,23,00,00), 8, 'ecliptic_echoes.jpg', (SELECT Id FROM ESTILOS WHERE Descripcion = 'Electronic'), (SELECT Id FROM TIPOSEDICION WHERE Descripcion = 'CD'));
--INSERT INTO DISCOS 
